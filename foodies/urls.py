...
urlpatterns=[
  ...
  path('viewaddress/<int:user_id>/',views.ViewAddressByUserIdApi.as_view(), name='view_address_by_user_id'),
  path('updateaddress/<int:userid>/<int:addressid>/',views.UpdateAddress_api.as_view(), name='update-address'),
